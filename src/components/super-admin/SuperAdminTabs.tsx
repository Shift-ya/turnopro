...
import type { SuperAdminTab, SuperAdminTenantFormData } from '../../types/superAdminDashboard';
...
export function SuperAdminTabs({
  ...
  if (activeTab === 'overview' && !loading && metrics) {
    return (
  ...
  if (activeTab === 'plans' && !loading && metrics) {
    return (
